...
// MỤC TIÊU: thật sự đáng sợ, ám ảnh — KHÔNG trẻ con, KHÔNG cartoon vui
export const WANSEE_IMAGE_STYLE =
  "Junji Ito manga art style, black ink illustration on white paper, heavy crosshatch shading, high contrast black and white with ONLY blood red as accent color. Deeply unsettling psychological horror — ONE specific thing in the scene is WRONG in a subtle but deeply disturbing way (shadow facing wrong direction, reflection doing something different, too many fingers, door that shouldn't exist, figure standing impossibly still, eyes in wrong places). Character has hollow sunken eyes, pale skin, visible exhaustion and fear but unaware of the horror behind them. Background packed with small disturbing details: scratches on walls, water stains, things half-visible in darkness, mold patterns that look like faces. Composition: character slightly off-center, the WRONG THING placed in background where viewer will notice it after a moment. Black and white ink wash technique, NOT colorful, NOT cute, NOT anime, pure Junji Ito horror manga style. 16:9 widescreen, NO text NO watermark";
